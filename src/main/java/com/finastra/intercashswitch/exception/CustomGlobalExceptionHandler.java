...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		ex.getSupportedHttpMethods().forEach(methodName -> builder.append(methodName + " "));

		ErrorDetails errorDetails = new ErrorDetails(HttpStatus.METHOD_NOT_ALLOWED, ex.getLocalizedMessage(),
				builder.toString());
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
		...
		ErrorDetails errorDetails = new ErrorDetails(HttpStatus.UNSUPPORTED_MEDIA_TYPE, ex.getLocalizedMessage(),
	...
	public final ResponseEntity<Object> handleUserManagementException(APIException ex, WebRequest request) {
